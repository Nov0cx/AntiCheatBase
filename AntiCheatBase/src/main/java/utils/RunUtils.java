...
public class RunUtils {
    ...
    private static final ScheduledExecutorService schedular = Executors.newSingleThreadScheduledExecutor();
    ...
    public static BukkitTask taskTimer(Runnable runnable, long delay, long interval) {
        return taskTimer(runnable, Lex.getInstance(), delay, interval);
    }
    ...
    public static BukkitTask taskTimerAsync(Runnable runnable, long delay, long interval) {
        return taskTimerAsync(runnable, Lex.getInstance(), delay, interval);
    }
    ...
    public static BukkitTask task(Runnable runnable) {
        return task(runnable, Lex.getInstance());
    }
    ...
    public static BukkitTask taskAsync(Runnable runnable) {
        return taskAsync(runnable, Lex.getInstance());
    }
    ...
    public static BukkitTask taskLater(Runnable runnable, long delay) {
        return taskLater(runnable, Lex.getInstance(), delay);
    }
