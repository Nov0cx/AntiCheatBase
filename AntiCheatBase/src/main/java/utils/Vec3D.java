...
import cc.funkemunky.api.utils.types.WrappedConstructor;
...
public class Vec3D extends NMSObject {
    ...
    public Vec3D a() {
        double var1 =  MathHelper.sqrt_double(this.a * this.a + this.b * this.b + this.c * this.c);
    ...
    public double b() {
        return  MathHelper.sqrt_double(this.a * this.a + this.b * this.b + this.c * this.c);
    }
